  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axiosClient.post("/post/create", formData, {
        withCredentials: true, // Required to send cookie with token
      });

      // If post is marked important, trigger notification
      if (formData.importance === "important") {
        await axiosClient.post("/post/notify-important-post", {
