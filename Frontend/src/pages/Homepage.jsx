                    ...
                    <div className="hidden md:flex items-center gap-8">
                        ...
                        <div className="relative group">
                            ...
                            <ul className="absolute right-0 mt-2 bg-black/90 backdrop-blur-xl text-white rounded-lg shadow-2xl py-2 opacity-0 group-hover:opacity-100 transition-all duration-300 z-10 w-48 border border-cyan-400/20">
                                <li><NavLink to="/your-reward" className="block px-4 py-3 hover:bg-cyan-600/20 transition-colors">Your Reward</NavLink></li>
                                <li><NavLink to="/attendance-summary" className="block px-4 py-3 hover:bg-cyan-600/20 transition-colors">Attendance</NavLink></li>
                                <li><NavLink to="/your-missions" className="block px-4 py-3 hover:bg-cyan-600/20 transition-colors">Your Missions</NavLink></li>
