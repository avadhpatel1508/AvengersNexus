            ...
            >
              <div className="relative">
                <motion.select
                  ...
                  className="appearance-none px-6 py-3 bg-gradient-to-r from-red-500 to-blue-500 text-white font-semibold rounded-lg focus:outline-none"
                  whileHover={{ scale: 1.05 }}
                >
              ...
              <div className="relative">
                <motion.input
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-red-500 to-blue-500 text-white font-semibold rounded-lg w-32 text-center focus:outline-none appearance-none"
                  min="2000"
                  max="2100"
                  whileHover={{ scale: 1.05 }}
                />
